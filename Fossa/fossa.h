...
#undef _XOPEN_SOURCE
#define _XOPEN_SOURCE 800 // @NOTE ÔÝÊ±¸Ä³É800 600    /* For flockfile() on Linux */
...
typedef closesocket(sock) close(sock)
#endif
 ...
 * class instance.
 */
DLL_EXPORT void ns_mgr_init(struct ns_mgr *mgr, void *user_data);
 ...
 */
DLL_EXPORT void ns_mgr_free(struct ns_mgr *);
 ...
 */
DLL_EXPORT time_t ns_mgr_poll(struct ns_mgr *, int milli);
 ...
 */
DLL_EXPORT void ns_broadcast(struct ns_mgr *, ns_event_handler_t func, void *, size_t);
 ...
 * ----
 */
DLL_EXPORT struct ns_connection *ns_next(struct ns_mgr *, struct ns_connection *);
 ...
 */
DLL_EXPORT struct ns_connection *ns_add_sock(struct ns_mgr *, sock_t, ns_event_handler_t);
 ...
 */
DLL_EXPORT struct ns_connection *ns_add_sock_opt(struct ns_mgr *, sock_t,
                                      ns_event_handler_t,
                                      struct ns_add_sock_opts);
 ...
 */
DLL_EXPORT struct ns_connection *ns_bind(struct ns_mgr *, const char *,
                              ns_event_handler_t);
/*
 * Create listening connection.
 *
 ...
 */
DLL_EXPORT struct ns_connection *ns_bind_opt(struct ns_mgr *, const char *,
 ...
 */
DLL_EXPORT struct ns_connection *ns_connect(struct ns_mgr *, const char *,
                                 ns_event_handler_t);
 ...
 * ----
 */
DLL_EXPORT struct ns_connection *ns_connect_opt(struct ns_mgr *, const char *,
                                     ns_event_handler_t,
                                     struct ns_connect_opts);
 ...
 */
DLL_EXPORT const char *ns_set_ssl(struct ns_connection *nc, const char *cert,
                       const char *ca_cert);
 ...
 * sent to the socket.
 */
DLL_EXPORT int ns_send(struct ns_connection *, const void *buf, int len);
 ...
 */
DLL_EXPORT int ns_printf(struct ns_connection *, const char *fmt, ...);

/* Same as `ns_printf()`, but takes `va_list ap` as an argument. */
DLL_EXPORT int ns_vprintf(struct ns_connection *, const char *fmt, va_list ap);
 ...
 */
DLL_EXPORT int ns_socketpair(sock_t[2], int sock_type);
 ...
 */
DLL_EXPORT int ns_resolve(const char *domain_name, char *ip_addr_buf, size_t buf_len);
 ...
 */
DLL_EXPORT int ns_check_ip_acl(const char *acl, uint32_t remote_ip);
 ...
 * other connections.
 */
DLL_EXPORT void ns_enable_multithreading(struct ns_connection *nc);
 ...
 */
DLL_EXPORT const char *ns_skip(const char *s, const char *end_string,
                    const char *delimiters, struct ns_str *v);

/*
 * Cross-platform version of `strncasecmp()`.
 */
DLL_EXPORT int ns_ncasecmp(const char *s1, const char *s2, size_t len);

/*
 * Cross-platform version of `strcasecmp()`.
 */
DLL_EXPORT int ns_casecmp(const char *s1, const char *s2);

/*
 * Cross-platform version of `strcmp()` where where first string is
 * specified by `struct ns_str`.
 */
DLL_EXPORT int ns_vcmp(const struct ns_str *str2, const char *str1);

/*
 * Cross-platform version of `strncasecmp()` where first string is
 * specified by `struct ns_str`.
 */
DLL_EXPORT int ns_vcasecmp(const struct ns_str *str2, const char *str1);
 ...
 */
DLL_EXPORT int ns_base64_decode(const unsigned char *s, int len, char *dst);
 ...
 * Destination is '\0'-terminated.
 */
DLL_EXPORT void ns_base64_encode(const unsigned char *src, int src_len, char *dst);
 ...
 */
DLL_EXPORT int ns_stat(const char *path, ns_stat_t *st);
 ...
 */
DLL_EXPORT FILE *ns_fopen(const char *path, const char *mode);
 ...
 */
DLL_EXPORT int ns_open(const char *path, int flag, int mode);
 ...
 */
DLL_EXPORT void *ns_start_thread(void *(*thread_func)(void *), void *thread_func_param);
// #endif
 ...
 */
DLL_EXPORT void ns_sock_to_str(sock_t sock, char *buf, size_t len, int flags);
 ...
 */
DLL_EXPORT void ns_sock_addr_to_str(const union socket_address *sa, char *buf, size_t len,
                         int flags);
 ...
 */
DLL_EXPORT int ns_hexdump(const void *buf, int len, char *dst, int dst_len);
 ...
 * event handler.
 */
DLL_EXPORT void ns_hexdump_connection(struct ns_connection *nc, const char *path,
 ...
 */
DLL_EXPORT int ns_avprintf(char **buf, size_t size, const char *fmt, va_list ap);

/*
 * Return true if target platform is big endian.
 */
DLL_EXPORT int ns_is_big_endian(void);
 ...
 */
DLL_EXPORT const char *ns_next_comma_list_entry(const char *list, struct ns_str *val,
 ...
 */
DLL_EXPORT int ns_match_prefix(const char *pattern, int pattern_len, const char *str);
 ...
 *   `struct websocket_message *`
 */
DLL_EXPORT void ns_set_protocol_http_websocket(struct ns_connection *nc);
 ...
 */
DLL_EXPORT void ns_send_websocket_handshake(struct ns_connection *nc, const char *uri,
 ...
 */
DLL_EXPORT void ns_send_websocket_frame(struct ns_connection *nc, int op, const void *data,
                             size_t data_len);
 ...
 */
DLL_EXPORT void ns_send_websocket_framev(struct ns_connection *nc, int op,
 ...
 */
DLL_EXPORT void ns_printf_websocket_frame(struct ns_connection *nc, int op,
                               const char *fmt, ...);
 ...
 * ```
 */
DLL_EXPORT void ns_send_http_chunk(struct ns_connection *nc, const char *buf, size_t len);

/*
 * Send printf-formatted HTTP chunk.
 * Functionality is similar to `ns_send_http_chunk()`.
 */
DLL_EXPORT void ns_printf_http_chunk(struct ns_connection *, const char *, ...);

/*
 * Send printf-formatted HTTP chunk, escaping HTML tags.
 */
DLL_EXPORT void ns_printf_html_escape(struct ns_connection *, const char *, ...);
 ...
 */
DLL_EXPORT int ns_parse_http(const char *s, int n, struct http_message *hm, int is_req);
 ...
 */
DLL_EXPORT struct ns_str *ns_get_http_header(struct http_message *hm, const char *name);
 ...
 */
DLL_EXPORT int ns_http_parse_header(struct ns_str *hdr, const char *var_name, char *buf,
                         size_t buf_size);
 ...
 *
 */
DLL_EXPORT size_t ns_parse_multipart(const char *buf, size_t buf_len, char *var_name,
 ...
 */
DLL_EXPORT int ns_get_http_var(const struct ns_str *, const char *, char *dst, size_t);

/* Create Digest authentication header for client request. */
DLL_EXPORT int ns_http_create_digest_auth_header(char *buf, size_t buf_len,
 ...
 * ----
 */
DLL_EXPORT struct ns_connection *ns_connect_http(struct ns_mgr *,
 ...
 * ----
 */
DLL_EXPORT void ns_serve_http(struct ns_connection *, struct http_message *,
                   struct ns_serve_http_opts);
 ...
 *  - #define JSON_TOKEN_ARRAY_TOO_SMALL    -3
 */
DLL_EXPORT int ns_rpc_parse_reply(const char *buf, int len, struct json_token *toks,
 ...
 */
DLL_EXPORT int ns_rpc_create_request(char *buf, int len, const char *method,
 ...
 * see https://github.com/cesanta/frozen
 */
DLL_EXPORT int ns_rpc_create_reply(char *buf, int len, const struct ns_rpc_request *req,
 ...
 * see https://github.com/cesanta/frozen
 */
DLL_EXPORT int ns_rpc_create_error(char *buf, int len, struct ns_rpc_request *req,
 ...
 * - #define JSON_RPC_SERVER_ERROR (-32000)
 */
DLL_EXPORT int ns_rpc_create_std_error(char *, int, struct ns_rpc_request *, int code);
 ...
 */
DLL_EXPORT int ns_rpc_dispatch(const char *buf, int, char *dst, int dst_len,
 ...
 * - NS_MQTT_SUBACK
 */
DLL_EXPORT void ns_set_protocol_mqtt(struct ns_connection *);

/* Send MQTT handshake. */
DLL_EXPORT void ns_send_mqtt_handshake(struct ns_connection *nc, const char *client_id);

/* Send MQTT handshake with optional parameters. */
DLL_EXPORT void ns_send_mqtt_handshake_opt(struct ns_connection *, const char *client_id,
                                struct ns_send_mqtt_handshake_opts);

/* Publish a message to a given topic. */
DLL_EXPORT void ns_mqtt_publish(struct ns_connection *nc, const char *topic,
                     uint16_t message_id, int flags, const void *data,
                     size_t len);

/* Subscribe to a bunch of topics. */
DLL_EXPORT void ns_mqtt_subscribe(struct ns_connection *nc,
                       const struct ns_mqtt_topic_expression *topics,
                       size_t topics_len, uint16_t message_id);

/* Unsubscribe from a bunch of topics. */
DLL_EXPORT void ns_mqtt_unsubscribe(struct ns_connection *nc, char **topics,
                         size_t topics_len, uint16_t message_id);

/* Send a DISCONNECT command. */
DLL_EXPORT void ns_mqtt_disconnect(struct ns_connection *nc);

/* Send a CONNACK command with a given `return_code`. */
DLL_EXPORT void ns_mqtt_connack(struct ns_connection *, uint8_t);

/* Send a PUBACK command with a given `message_id`. */
DLL_EXPORT void ns_mqtt_puback(struct ns_connection *, uint16_t);

/* Send a PUBREC command with a given `message_id`. */
DLL_EXPORT void ns_mqtt_pubrec(struct ns_connection *, uint16_t);

/* Send a PUBREL command with a given `message_id`. */
DLL_EXPORT void ns_mqtt_pubrel(struct ns_connection *, uint16_t);

/* Send a PUBCOMP command with a given `message_id`. */
DLL_EXPORT void ns_mqtt_pubcomp(struct ns_connection *, uint16_t);

/*
 * Send a SUBACK command with a given `message_id`
 * and a sequence of granted QoSs.
 */
DLL_EXPORT void ns_mqtt_suback(struct ns_connection *, uint8_t *, size_t, uint16_t);

/* Send a UNSUBACK command with a given `message_id`. */
DLL_EXPORT void ns_mqtt_unsuback(struct ns_connection *, uint16_t);

/* Send a PINGREQ command. */
DLL_EXPORT void ns_mqtt_ping(struct ns_connection *);

/* Send a PINGRESP command. */
DLL_EXPORT void ns_mqtt_pong(struct ns_connection *);
 ...
 */
DLL_EXPORT int ns_mqtt_next_subscribe_topic(struct ns_mqtt_message *, struct ns_str *,
                                 uint8_t *, int);
...
DLL_EXPORT struct ns_dns_resource_record *ns_dns_next_record(
 ...
 * TODO(mkm): MX
 */
DLL_EXPORT int ns_dns_parse_record_data(struct ns_dns_message *,
                             struct ns_dns_resource_record *, void *, size_t);

/*
 * Send a DNS query to the remote end.
 */
DLL_EXPORT void ns_send_dns_query(struct ns_connection *, const char *, int);
 ...
 */
DLL_EXPORT int ns_dns_insert_header(struct mbuf *, size_t, struct ns_dns_message *);
 ...
 */
DLL_EXPORT int ns_dns_copy_body(struct mbuf *, struct ns_dns_message *);
 ...
 */
DLL_EXPORT int ns_dns_encode_record(struct mbuf *, struct ns_dns_resource_record *,
                         const char *, size_t, const void *, size_t);

/* Low-level: parses a DNS response. */
DLL_EXPORT int ns_parse_dns(const char *, int, struct ns_dns_message *);
 ...
 */
DLL_EXPORT size_t ns_dns_uncompress_name(struct ns_dns_message *, struct ns_str *, char *,
                              int);
 ...
 */
DLL_EXPORT void ns_set_protocol_dns(struct ns_connection *);
...
DLL_EXPORT int ns_resolve_async(struct ns_mgr *, const char *, int, ns_resolve_callback_t,
                     void *data);
 ...
 * ----
 */
DLL_EXPORT int ns_resolve_async_opt(struct ns_mgr *, const char *, int,
 ...
 */
DLL_EXPORT int ns_resolve_from_hosts_file(const char *host, union socket_address *usa);
